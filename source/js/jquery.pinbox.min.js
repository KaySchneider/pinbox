(function(a){var h={afterLoad:function(b){if(!0==a.fn.pinbox.staticInfo.isRun)return 1;a.fn.pinbox.staticInfo.isRun=!0;container=a(b.subcontainer+"."+b.newitemindicator,a(this));var e=h.buildMatrix.apply(this,[container]);h.setPositions.apply(this,[e,b]);return container},buildMatrix:function(b){var e=[],d=[],c=0;a(b).each(function(){c++;d.push(this);5===c&&(c=0,e.push(d),d=[])});0<d.length&&e.push(d);return e},setPositions:function(b,e){var d=a.fn.pinbox.staticInfo,c=h;a(b).each(function(b){a(this).each(function(f){if(0<
